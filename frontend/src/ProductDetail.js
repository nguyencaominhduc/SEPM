                        ...
                        <div className="col-md-12 product-slier-details">
                          <ul id="lightSlider">
                            <li data-thumb="img/product-img/product-description-1.jpg">
                              <img className="figure-img img-fluid" src="img/product-img/product-description-1.jpg" alt="product-img" />
                            </li>
                            <li data-thumb="img/product-img/product-description-1.jpg">
                              <img className="figure-img img-fluid" src="img/product-img/product-description-1.jpg" alt="product-img" />
                            </li>
                  ...
                  <div className="wd-tab-section">
                    <div className="tab-pane" id="description-section">
                      ...
                      <div className="product-tab-content">
                        <h4 className="description-title">Vigo SP111-31N-P2GH Spin 1 Details</h4>
                        ...
                        <div className="row tab-gallery">
                          <div className="col-6 col-md-3">
                            <img className="figure-img img-fluid" src="img/product-img/tab-img-1.jpg" alt="features" />
                          </div>
                          <div className="col-6 col-md-3">
                            <img className="figure-img img-fluid" src="img/product-img/tab-img-2.jpg" alt="features" />
                          </div>
                          <div className="col-6 col-md-3">
                            <img className="figure-img img-fluid" src="img/product-img/tab-img-3.jpg" alt="features" />
                          </div>
                          <div className="col-6 col-md-3">
                            <img className="figure-img img-fluid" src="img/product-img/tab-img-4.jpg" alt="features" />
                          </div>
                        </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 col-md-12 col-lg-6">
                            <img className="figure-img img-fluid" src="img/product-img/tab-img-5.jpg" alt="Features" />
                          </div>
                        </div>
                      </div>
                      <hr />
                      <div className="row tab-video-area">
                        <div className="col-12 col-md-12 col-lg-6">
                          <img className="figure-img img-fluid" src="img/product-img/tab-img-6.jpg" alt="Features" />
                        </div>
              ...
              <div className="row related-product">
                ...
                <div id="related-product" className="owl-carousel owl-theme">
                  <div className="col-12">
                    <figure className="figure product-box">
                      <div className="product-box-img">
                        <img src="img/product-img/product-img-1.jpg" className="figure-img img-fluid" alt="Product Img" />
                      </div>
                  ...
                  <div className="col-12">
                    <figure className="figure product-box">
                      <div className="product-box-img">
                        <img src="img/product-img/product-img-2.jpg" className="figure-img img-fluid" alt="Product Img" />
                      </div>
                      <div className="quick-view-btn">
                        <div className="compare-btn">
                          <a className="btn btn-primary btn-sm" href="#"><i className="fa fa-eye" aria-hidden="true" /> Quick view</a>
                  ...
                  <div className="col-12">
                    <figure className="figure product-box">
                      <div className="product-box-img">
                        <img src="img/product-img/product-img-3.jpg" className="figure-img img-fluid" alt="Product Img" />
                      </div>
                      <div className="quick-view-btn">
                        <div className="compare-btn">
                          <a className="btn btn-primary btn-sm" href="#"><i className="fa fa-eye" aria-hidden="true" /> Quick view</a>
                  ...
                  <div className="col-12">
                    <figure className="figure product-box">
                      <div className="product-box-img">
                        <img src="img/product-img/product-img-4.jpg" className="figure-img img-fluid" alt="Product Img" />
                      </div>
                      <div className="quick-view-btn">
                        <div className="compare-btn">
                          <a className="btn btn-primary btn-sm" href="#"><i className="fa fa-eye" aria-hidden="true" /> Quick view</a>
                  ...
                  <div className="col-12">
                    <figure className="figure product-box">
                      <div className="product-box-img">
                        <img src="img/product-img/product-img-5.jpg" className="figure-img img-fluid" alt="Product Img" />
                      </div>
                      <div className="quick-view-btn">
                        <div className="compare-btn">
                          <a className="btn btn-primary btn-sm" href="#"><i className="fa fa-eye" aria-hidden="true" /> Quick view</a>
              ...
              <div className="row wow fadeInLeft animated justify-content-center" data-wow-delay="600ms">
                  ...
                  <div className="row">
                    <div className="col-sm-3 p0 text-center">
                      <div className="details-img">
                        <img className="img-fluid main-hover-icon-compare" src="img/details-img/compare-icon.png" alt="compare-icon" />
                        <img className="img-fluid hover-icon-compare" src="img/details-img/compare.png" alt="compare-icon" />
                      </div>
                    </div>
                ...
                <div className="col-10 col-sm-8 col-lg-3 details-box">
                  <div className="row">
                    <div className="col-sm-3 p0 text-center">
                      <div className="details-img">
                        <img className="img-fluid main-hover-icon-user" src="img/details-img/review-icon.png" alt="review-icon" />
                        <img className="img-fluid hover-icon-user" src="img/details-img/user-2.png" alt="review-icon" />
                      </div>
                    </div>
                    <div className="col-sm-9 p0 details-description">
                ...
                <div className="col-10 col-sm-8 col-lg-3 details-box">
                  <div className="row">
                    <div className="col-sm-3 p0 text-center">
                      <div className="details-img">
                        <img className="img-fluid main-hover-icon-vendor" src="img/details-img/shop.png" alt="vendor-icon" />
                        <img className="img-fluid hover-icon-vendor" src="img/details-img/vendor-icon.png" alt="vendor-icon" />
                      </div>
                    </div>
                    <div className="col-sm-9 p0 details-description">
                ...
                <div className="col-10 col-sm-8 col-lg-3 details-box details-active">
                  <div className="text-center">
                    <img className="img-fluid" src="img/details-img/gift-icon.png" alt="gift-icon" />
