...
class ProductDetail extends React.Component {
              ...
              <div className="col-sm-12 col-md-4 col-lg-5 col-xl-6 d-none d-md-block">
                <div className="offer-text text-center">
                  <p className="text-uppercase">
                    upto 50% off to all virtual products
                  </p>
                </div>
              </div>
              {/* =========================
                  ...
                  >
                    <div className="btn-group" role="group">
                      <button
                        id="btnGroupDrop3"
                        type="button"
                        className="btn btn-secondary wd-btn-country dropdown-toggle"
                      ...
                      <div
                        className="dropdown-menu wd-btn-country-list"
                        aria-labelledby="btnGroupDrop3"
                      >
                        <a className="dropdown-item" href="#">
                          <img
                            src={require("./img/flag-icon-2.png")}
                            alt="flag-icon"
                          />{" "}
                          Bangla
                        </a>
                        <a className="dropdown-item" href="#">
                          <img
                            src={require("./img/flag-icon-3.png")}
                            alt="flag-icon"
                          />{" "}
                          Spanish
                        </a>
                  ...
                  >
                    <div className="btn-group" role="group">
                      <button
                        id="btnGroupDrop4"
                        type="button"
                        className="btn btn-secondary wd-btn-language dropdown-toggle"
                        data-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                      ...
                      <div
                        className="dropdown-menu wd-btn-language-list"
  ...
  Header Top Section
    ============================== */}
        <section
          id="wd-header"
          className="d-flex align-items-center mob-sticky"
        >
          <div className="container">
            <div className="row">
              {/* =========================
              ...
              <div className="order-2 order-sm-1 col-2 col-sm-2 col-md-4 d-block d-lg-none">
                <div className="accordion-wrapper hide-sm-up">
                  ...
                  <ul id="mobilemenu" className="accordion">
                    ...
                    <li>
                      <div className="link">
                        Comparison Product <i className="fa fa-chevron-down" />
                      </div>
                      <ul className="submenu font-sky">
                        <li>
              ...
              <div className="col-12 order-lg-2 col-md-5 col-lg-6 col-xl-5 d-none d-lg-block">
                <div className="input-group wd-btn-group header-search-option">
                  <input
                    type="text"
                    className="form-control blurb-search"
                    placeholder="Search ..."
                                            ...
                                            <div className="login-form text-left">
                                              <form>
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputEmail-login">
                                                    User name
                                                  </label>
                                                  <input
                                                    type="text"
                                                ...
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputPassword-login-pass-2">
                                                    Password
                                                  </label>
                                                  <input
                                                    type="password"
                                          ...
                                          <div className="sign-up-section text-center">
                                            <div className="login-form text-left">
                                              <form>
                                                ...
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputEmail-sign-up">
                                                    Email
                                                  </label>
                                                  <input
                                                    type="text"
                                                ...
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputPassword-login-pass">
                                                    Password
                                                  </label>
                                                  <input
                                                    type="password"
                        ...
                        <div className="wd-item-list">
                          <div className="media">
                            <img
                              ...
                              src={require("./img/cart-img-1.jpg")}
                              alt="cart-img"
                            />
                            <div className="media-body">
                          ...
                          <div className="media">
                            <img
                              className="d-flex mr-3"
                              src={require("./img/cart-img-2.jpg")}
                              alt="cart-img"
                            />
                            <div className="media-body">
                              <h6 className="mt-0 list-group-title">
                    ...
                    <ul className="wd-megamenu-ul">
                      <li>
                        ...
                        <ul className="single-dropdown">
                          ...
                          <li>
                            <a href="index-01-02.html">Home page 1 Fullwidth</a>
                          </li>
                          <li>
              ...
              <div className="col-6 col-md-4 col-lg-5 text-right ext-right p0  d-none ">
                <div className="account-and-search">
                  <div className="account-section">
                    ...
                    <div
                      className="modal wd-ph-modal fade bd-example-modal-lg"
                      tabIndex={-1}
                      aria-hidden="true"
                    >
                      <div className="modal-dialog modal-lg">
                            ...
                            <div className="row text-left">
                              <div className="col-md-12 p0">
                                <div className="modal-tab-section wd-modal-tabs">
                                  ...
                                  <div
                                    className="tab-content"
                                    id="myTabContent-account"
                                  >
                                    <div
                                      className="tab-pane fade show active"
                                      id="login-2"
                                      role="tabpanel"
                                      aria-labelledby="login-tab-2"
                                    >
                                      <div className="row">
                                        <div className="col-md-6 p0 brand-description-area">
                                          <img
                                        ...
                                        <div className="col-12 col-md-12 col-lg-6 p0">
                                          <div className="sign-up-section text-center">
                                            <div className="login-form text-left">
                                              <form>
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputname-login-in">
                                                    First name
                                                  </label>
                                                  <input
                                                    type="text"
                                                    className="form-control"
                                                    id="exampleInputname-login-in"
                                                    placeholder="First Name"
                                                  />
                                                </div>
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputname-login-in-2">
                                                    Last name
                                                  </label>
                                                  <input
                                                    type="text"
                                                    className="form-control"
                                                    id="exampleInputname-login-in-2"
                                                    placeholder="Last Name"
                                                  />
                                                </div>
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputEmail-login-in">
                                                    Email
                                                  </label>
                                                  <input
                                                    type="text"
                                                    className="form-control"
                                                    id="exampleInputEmail-login-in"
                                                    placeholder="Enter you email ..."
                                                  />
                                                </div>
                                                <div className="form-group">
                                                  <label htmlFor="exampleInputPassword-login-in">
                                                    Password
                                                  </label>
                                                  <input
                                                    type="password"
                                                    className="form-control"
                                                    id="exampleInputPassword-login-in"
                                                    placeholder="*** *** ***"
                                                  />
                                                </div>
                                                <button
  ...
  CopyRight
    ============================== */}
        <section
          className="copyright wow fadeInUp animated"
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="copyright-text">
                  <p className="text-uppercase">COPYRIGHT © 2018</p>
              ...
              <div className="col-md-6">
                <div className="brand-logo">
                  <a href="#">
                    <img
                      src={require("./img/social-media-img/brand-logo-1.jpg")}
                      className="img-fluid"
                      alt="Brand Logo"
                    />
                  </a>
                  <a href="#">
                    <img
                      src={require("./img/social-media-img/brand-logo-2.jpg")}
                      className="img-fluid"
                      alt="Brand Logo"
                    />
                  </a>
                  <a href="#">
                    <img
                      src={require("./img/social-media-img/brand-logo-3.jpg")}
                      className="img-fluid"
                      alt="Brand Logo"
                    />
                  </a>
                  <a href="#">
                    <img
                      src={require("./img/social-media-img/brand-logo-4.jpg")}
                      className="img-fluid"
                      alt="Brand Logo"
                    />
                  </a>
                  <a href="#">
                    <img
                      src={require("./img/social-media-img/brand-logo-5.jpg")}
                      className="img-fluid"
                      alt="Brand Logo"
                    />
                  </a>
