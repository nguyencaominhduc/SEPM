...
class Page extends React.Component {
          ...
          <div className="input-group">
            <div className="input-group-btn">
              <button type="button" className="btn btn-secondary wd-slider-search-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                All Categories <i className="fa fa-angle-down" aria-hidden="true" />
              </button>
                ...
                <div className="search-category">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <ul>
                        <li><a href="#"><i className="fa fa-angle-double-right" aria-hidden="true" /> Camera Electronice</a></li>
                        <li><a href="#"><i className="fa fa-angle-double-right" aria-hidden="true" /> Camera Appereances</a></li>
                        <li><a href="#"><i className="fa fa-angle-double-right" aria-hidden="true" /> DSLR</a></li>
                        <li><a href="#"><i className="fa fa-angle-double-right" aria-hidden="true" /> Video cameras</a></li>
                        <li><a href="#"><i className="fa fa-angle-double-right" aria-hidden="true" /> Top Cameras</a></li>
                      </ul>
                    </div>
                    <div className="col-md-6">
                      <h6 className="search-category-title">Cameras and photos</h6>
            ...
            <span className="input-group-btn">
              <button className="btn btn-secondary wd-search-btn" type="button"><i className="fa fa-search" aria-hidden="true" /></button>
            </span>
          </div>
        </div>
              ...
              <ul className="list-group">
                <li className="list-group-item">
                  <a href="#!">
                    ...
                    <span className="sub-list-main-menu">Furniture</span> <i className="fa fa-angle-right" aria-hidden="true" />
                  </a>
                  <div className="wd-sub-list">
                    <div className="container">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <a href="product-details-scroll.html"><img src="img/department-img/department-sub-list-img-1.jpg" className="department-sub-list-img" alt="department-sub-list-img" /></a>
                        </div>
                        <div className="col-md-6">
                          <a href="product-details-scroll.html"><img src="img/department-img/department-sub-list-img-2.jpg" className="department-sub-list-img" alt="department-sub-list-img" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-2.png" alt="" />
                    </div><span className="sub-list-main-menu">Household</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-3.png" alt="" />
                    </div><span className="sub-list-main-menu">Clothes</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-4.png" alt="" />
                    </div><span className="sub-list-main-menu">Accessories</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-5.png" alt="" />
                    </div><span className="sub-list-main-menu">Electronics</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-6.png" alt="" />
                    </div><span className="sub-list-main-menu">Corporate staff</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-7.png" alt="" />
                    </div><span className="sub-list-main-menu">Sinking staff</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-8.png" alt="" />
                    </div><span className="sub-list-main-menu">Plant</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-9.png" alt="" />
                    </div><span className="sub-list-main-menu">Washing machine</span></a>
                </li>
                <li className="list-group-item"><a href="product-details-scroll.html">
                    <div className="department-list-logo">
                      <img src="img/department-img/department-img-10.png" alt="" />
                    </div><span className="sub-list-main-menu">Winding staff</span></a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="menu-container wd-megamenu text-left">
              <div className="menu">
                <ul className="wd-megamenu-ul">
                  ...
                  <li><a href="blog-four-grid-left-sidebar.html" className="main-menu-list">Blog</a>
                    <ul className="single-dropdown">
                      <li><a href="blog-full-grid.html">Blog Full Grid</a></li>
                      <li><a href="blog-two-grid.html">Blog Two Grid</a></li>
                      <li><a href="blog-three-grid.html">Blog Three Grid</a></li>
  ...
  <section className="wd-service">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.2s">
          <ul className="list-unstyled">
            <li className="media">
              <img className="d-flex mr-3" src="img/compare-icon.png" alt="compare-icon" />
              <div className="media-body">
        ...
        <div className="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.4s">
          <ul className="list-unstyled">
            <li className="media">
              <img className="d-flex mr-3" src="img/review-icon.png" alt="compare-icon" />
              <div className="media-body">
        ...
        <div className="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.6s">
          <ul className="list-unstyled">
            <li className="media">
              <img className="d-flex mr-3" src="img/store-icon.png" alt="compare-icon" />
              <div className="media-body">
                <h5 className="wd-service-title mt-0 mb-1">Choose Multi-Vendor Store</h5>
                <p>Choose your product with price comparisons make your best deal today</p>
              </div>
            </li>
          </ul>
        ...
        <div className="row m0 justify-content-center ">
            ...
            <div className="media">
              <div className="row">
                <div className="col-sm-4 col-md-5">
                  <img className="img-fluid" src="img/product-img/product-img-9.jpg" alt="Generic placeholder image" />
                </div>
          ...
          <div className="col-12 col-md-6 col-lg-4 p0 amazon-review-box wow fadeIn animated" data-wow-delay="0.4s">
            <div className="media">
              <div className="row">
                <div className="col-sm-4 col-md-5">
                  <img className="img-fluid" src="img/product-img/product-img-22.jpg" alt="Generic placeholder image" />
                </div>
                <div className="col-sm-8 col-md-7 p0 d-flex align-items-center">
                  <div className="amazon-review-box-content">
                    <div className="rating">
          ...
          <div className="col-12 col-md-6 col-lg-4 p0 amazon-review-box wow fadeIn animated" data-wow-delay="0.6s">
            <div className="media">
              <div className="row">
                <div className="col-sm-4 col-md-5">
                  <img className="img-fluid" src="img/product-img/product-img-23.jpg" alt="Generic placeholder image" />
                </div>
                <div className="col-sm-8 col-md-7 p0 d-flex align-items-center">
                  <div className="amazon-review-box-content">
                    <div className="rating">
  ...
  <section id="categories">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-12 col-md-6 col-lg-6 col-xl-4 wow fadeIn animated" data-wow-delay="300ms">
          <div className="categories-big-box">
            ...
            <div data-video="cBNBnpmyGM0" id="video">
              <img className="figure-img img-fluid" src="img/2.jpg" alt="Youtube Video" />
            </div>
          </div>
        </div>
        <div className="col-12 col-md-6 col-lg-6 col-xl-4">
          <div className="categories-small-box wow fadeIn animated" data-wow-delay="600ms">
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <div className="d-flex justify-content-start align-items-center">
                    <div className="categories-info">
                      <h2 className="categories-name">Smart Phone</h2>
                      <p className="categories-content">Brilliant visual displays Monitors</p>
                      <a href="shop-left-sidebar.html" className="btn btn-primary wd-shop-btn">
                        Shop now
                      </a>
                    </div>
                    <div className="categories-img align-items-center">
                      <img src="img/categories/categories-img-24.jpg" className="img-fluid" alt="categories-img" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="categories-small-box wow fadeIn animated" data-wow-delay="900ms">
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <div className="d-flex justify-content-start align-items-center">
                    <div className="categories-img align-items-center">
                      <img src="img/categories/categories-img-2.jpg" className="img-fluid" alt="categories-img" />
                    </div>
                    <div className="categories-info">
                      <h2 className="categories-name">Phone 6610</h2>
                      <p className="categories-content">Brilliant visual displays Monitors</p>
                      <a href="shop-left-sidebar.html" className="btn btn-primary wd-shop-btn">
                        Shop now
                      </a>
        ...
        <div className="col-12 col-md-12 col-lg-12 col-xl-4 wow fadeIn animated" data-wow-delay="1200ms">
          <div className="categories-big-box text-center">
            <div className="featured-img">
              <img src="img/categories/categories-img-3.jpg" className="img-fluid" alt="featured-img" />
            </div>
  ...
  <section id="big-message">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-12 col-md-12 col-lg-4 wow fadeInLeft animated" data-wow-delay="300ms">
          ...
          <div className="message-bar-chart">
            <img src="img/message-bar-chart.png" className="img-fluid" alt="message-bar-chart" />
          </div>
        </div>
        <div className="col-md-1" />
        <div className="col-12 col-md-12 col-lg-7 wow fadeInRight animated" data-wow-delay="300ms">
  ...
  <section id="recent-product" className="recent-pro-2">
    <div className="container-fluid custom-width">
      <div className="row">
        ...
        <div className="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="100ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-12.jpg" className="img-fluid" alt="recent-product img" /></a>
              ...
              <div className="recent-product-info">
                ...
                <div className="recent-product-meta-link">
                  <a href="#"><i className="fa fa-star active-color" aria-hidden="true" /><strong>4.5</strong></a>
                  <a href="#">
                    <img src="img/product-img/compare.png" alt="" />
                    <img className="compare-white" src="img/product-img/compare-white.png" alt="" />
                  </a>
                  <a href="#"><i className="fa fa-comments-o" aria-hidden="true" />145</a>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="200ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-13.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge green-bg text-uppercase">Hot</span>
              <div className="recent-product-info">
                <div className="d-flex justify-content-between">
                  <div className="recent-price">
                    $15.45 - $50.00
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="300ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-15.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
              <div className="recent-product-info">
                <div className="d-flex justify-content-between">
                  <div className="recent-price">
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="400ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-16.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
              <div className="recent-product-info">
                <div className="d-flex justify-content-between">
                  <div className="recent-price">
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="500ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-14.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
              <div className="recent-product-info">
                <div className="d-flex justify-content-between">
                  <div className="recent-price">
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="600ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-17.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
              <div className="recent-product-info">
                <div className="d-flex justify-content-between">
                  <div className="recent-price">
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="700ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-15.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="900ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-16.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1000ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-12.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1200ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-17.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
        ...
        <div className="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1400ms">
          <div className="recent-product-box">
            <div className="recent-product-img">
              <a href="product-details.html"><img src="img/product-img/product-img-13.jpg" className="img-fluid" alt="recent-product img" /></a>
              <span className="badge badge-secondary wd-badge text-uppercase">New</span>
  ...
  <section id="offer-time">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-12 col-md-12 col-lg-12 col-xl-6 wow fadeInLeft animated" data-wow-delay="300ms">
          <div className="offer-time-box">
            <div className="row">
              <div className="col-sm-5 col-md-6">
                <img src="img/nokia.jpg" alt="offer img" className="offer-img" />
              </div>
              <div className="col-sm-7 col-md-6 d-flex align-items-center">
                <div className="offer-content">
                  <p className="offer-brand-name">Phone 6670</p>
                  <h2 className="offer-title">SALE 75% <span>OFF</span></h2>
                  <p className="offer-price">At $199 - Only for today</p>
                  <div className="countdown" data-date="2018-12-31" />
        ...
        <div className="col-12 col-md-12 col-lg-12 col-xl-6 wow fadeInRight animated" data-wow-delay="300ms">
          <div className="offer-time-box">
            <div className="row">
              <div className="col-sm-5 col-md-6">
                <img src="img/iphon.jpg" alt="offer img" className="offer-img" />
              </div>
              <div className="col-sm-7 col-md-6 d-flex align-items-center">
                <div className="offer-content">
  ...
  <section id="wd-news">
    <div className="container-fluid custom-width">
      <div className="row">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="300ms">
          <div className="wd-news-box">
            <figure className="figure">
              <figcaption />
              <img src="img/blog/news-img-1.jpg" className="figure-img img-fluid rounded" alt="news-img" />
              <div className="wd-news-info">
                <div className="figure-caption"><a href="single-blog-with.html">ThemeIM provides best affiliate theme and templates like BLURB</a></div>
                <p className="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
                <a href="single-blog-with.html" className="badge badge-light wd-news-more-btn">Read More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
              </div>
              <span className="angle-right-to-left" />
            </figure>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="600ms">
          <div className="wd-news-box">
            <figure className="figure">
              <figcaption />
              <img src="img/blog/news-img-2.jpg" className="figure-img img-fluid rounded" alt="news-img" />
              <div className="wd-news-info">
                <div className="figure-caption"><a href="single-blog-with.html">Top 10 affiliate themes and templates you get from ThemeIM</a></div>
                <p className="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
                <a href="single-blog-with.html" className="badge badge-light wd-news-more-btn">Read More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
              </div>
              <span className="angle-left-to-right" />
            </figure>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="900ms">
          <div className="wd-news-box">
            <figure className="figure">
              <figcaption />
              <img src="img/blog/news-img-3.jpg" className="figure-img img-fluid rounded" alt="news-img" />
              <div className="wd-news-info">
                <div className="figure-caption"><a href="single-blog-with.html">Make pixel perfect design and development from ThemeIM</a></div>
                <p className="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
                <a href="single-blog-with.html" className="badge badge-light wd-news-more-btn">Read More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
              </div>
              <span className="angle-right-to-left" />
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="1200ms">
          <div className="wd-news-box">
            <figure className="figure">
              <figcaption />
              <img src="img/blog/news-img-4.jpg" className="figure-img img-fluid rounded" alt="news-img" />
              <div className="wd-news-info">
                <div className="figure-caption"><a href="single-blog-with.html">Best US top catagories affiliate product list from BLURB Theme</a></div>
                <p className="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
                <a href="single-blog-with.html" className="badge badge-light wd-news-more-btn">Read More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
              </div>
              <span className="angle-left-to-right" />
  ...
  Call To Action Section
    ============================== */}
  <section id="call-to-action" className=" wow fadeInUp animated" data-wow-delay="0ms">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-12 col-md-12 col-lg-6">
          <h2 className="call-to-action-message">Affiliate with <span className="bold-font">BLURB</span> Theme &amp; Get Maximum
 ...
 Partner Section
  ...
  <section id="partner" className="text-center">
    <div className="container-fluid custom-width">
      <div className="row">
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="0ms">
          <img src="img/partner/partner-img-1.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="300ms">
          <img src="img/partner/partner-img-2.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="600ms">
          <img src="img/partner/partner-img-3.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="900ms">
          <img src="img/partner/partner-img-4.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="1200ms">
          <img src="img/partner/partner-img-5.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
        <div className="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="1400ms">
          <img src="img/partner/partner-img-6.jpg" className="figure-img img-fluid" alt="partner-img" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container-fluid custom-width">
      <div className="row">
        ...
        <div className="col-6 col-md-3 col-lg-2 footer-nav">
          ...
          <div className="stores-list">
            ...
            <ul>
              ...
              <li><a href="shop-left-sidebar.html">Affiliate Market 6</a></li>
            </ul>
          </div>
        </div>
        <div className="col-6 col-md-3 col-lg-2 footer-nav">
        ...
        <div className="col-12 col-md-12 col-lg-2">
          ...
          <p className="newsletter-content">By subscribing to our mailing list you will always be update with the latest news from us.</p>
  ...
  CopyRight
    ============================== */}
  <section className="copyright wow fadeInUp animated copyright-2" data-wow-delay="1500ms">
    <div className="container">
      <div className="row">
        <div className="col-md-6">
        ...
        <div className="col-md-6">
          <div className="brand-logo">
            <a href="#">
              <img src="img/social-media-img/brand-logo-1.jpg" className="img-fluid" alt="Brand Logo" />
            </a>
            <a href="#">
              <img src="img/social-media-img/brand-logo-2.jpg" className="img-fluid" alt="Brand Logo" />
            </a>
            <a href="#">
              <img src="img/social-media-img/brand-logo-3.jpg" className="img-fluid" alt="Brand Logo" />
            </a>
            <a href="#">
              <img src="img/social-media-img/brand-logo-4.jpg" className="img-fluid" alt="Brand Logo" />
            </a>
            <a href="#">
              <img src="img/social-media-img/brand-logo-5.jpg" className="img-fluid" alt="Brand Logo" />
            </a>
          </div>
        </div>
      </div>
